...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        data =  pd.DataFrame()
        data['count'] = spacex_df[spacex_df['Launch Site']
                         == entered_site]['class'].value_counts()
        data['result'] = ['Failure','Success']                 

        return px.pie(data, values='count', names='result', title=f'Total Success Launch by {entered_site}', color_discrete_map={'Failure': 'red',
                                                                                                                                 'Success': 'green',})
...
def get_scatter_chart(entered_site,range):
    ...
    if entered_site == 'ALL':
        ...
        return px.scatter(spacex_df[mask][spacex_df['Launch Site'] == entered_site], x='Payload Mass (kg)',
                                y='class',)
